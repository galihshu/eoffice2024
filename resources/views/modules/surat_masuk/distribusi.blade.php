...
@section('title', 'Distribusi Surat Masuk')
        ...
        <div class="xl:col-span-12 col-span-12">
            <div class="box custom-box">
                <div class="box-header justify-between">
                    <div class="box-title">
                        Form Distribusi Surat Masuk
                    </div>
                </div>
                <div class="box-body">
                    <form action="{{ route('surat_masuk.distribusi.store', $suratMasuk->id)}}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-span-12 mb-4 sm:mb-0 {{ $errors->has('tgl_disposisi') ? ' !border-red' : '' }}">
                            <label class="form-label" for="tgl_disposisi">Tanggal Distribusi</label>
                        ...
                        <div class="col-span-12 mb-4 sm:mb-0 {{ $errors->has('keterangan') ? ' !border-red' : '' }}">
                            <label class="form-label" for="keterangan">Keterangan Distribusi</label>
