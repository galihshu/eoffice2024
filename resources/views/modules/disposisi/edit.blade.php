    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="xl:col-span-12 col-span-12">
            <div class="box custom-box">
                ...
                <div class="box-body">
                    <form action="{{ route('disposisi.update', $disposisi)}}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-span-12 mb-4 sm:mb-0 {{ $errors->has('tujuan') ? ' !border-red' : '' }}">
                            ...
                            value="{{ $disposisi->user_id_tujuan }}" required>
                        ...
                        <div class="col-span-12 mb-4 sm:mb-0 {{ $errors->has('tgl_disposisi') ? ' !border-red' : '' }}">
                            ...
                            <input type="date" name="tgl_disposisi" id="tgl_disposisi"
                                placeholder="Masukan tanggal diterima" class="form-control" value="{{ $disposisi->tgl_disposisi ? $disposisi->tgl_disposisi->format('Y-m-d') : '' }}">
                            @error('tgl_disposisi')
                                <span class="text-red-500 text-xs hidden" style="display: block;">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-span-12 mb-4 sm:mb-0 {{ $errors->has('keterangan') ? ' !border-red' : '' }}">
                            ...
                            <textarea name="keterangan" id="keterangan" cols="30" rows="10" class="form-control">{{$disposisi->keterangan_disposisi}}</textarea>
                            @error('keterangan')
                                <span class="text-red-500 text-xs hidden" style="display: block;">
                                    {{ $message }}
                                </span>
