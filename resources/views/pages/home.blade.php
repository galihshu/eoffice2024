            ...
            <nav class="main-menu-container nav nav-pills flex-column sub-open">
                ...
                <div class="responsive-logo">
                    <a class="responsive-logo-light" href="{{ route('landing') }}" aria-label="Brand"><img
                        src="{{ asset('eofficeadmin/images/brand-logos/eoffice-logo-dark.png') }}" alt="logo" class="mx-auto"></a>
                    <a class="responsive-logo-dark" href="{{ route('landing') }}" aria-label="Brand"><img
                        src="{{ asset('eofficeadmin/images/brand-logos/eoffice-logo.png') }}" alt="logo" class="mx-auto"></a>
                </div>
                </div>
                ...
                <a href="{{ route('login') }}" class="ti-btn w-[15.375rem] ti-btn-primary-full m-0 p-2">Login E-Office</a>
...
@section('content')
    ...
    <div class="main-content !p-0 landing-main dark:text-defaulttextcolor/70">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        <div class="xxl:col-span-7 xl:col-span-7 lg:col-span-7 col-span-12">
                            <div class="lg:py-[3rem]">
                                <div class="mb-4">
                                    <h5 class="font-semibold text-white opacity-[0.9] text-[1.25rem]">Mengelola Arsip dengan Mudah dan Aman</h5>
                                </div>
                                <p class="landing-banner-heading mb-4 opacity-[0.9]">Transformasi Digital Pengelolaan Arsip Anda</p>
                                <div class="text-[1rem] mb-[3rem] text-white opacity-[0.9]">Nikmati kemudahan pengelolaan arsip dengan fitur pencarian canggih, keamanan data yang terjamin, dan aksesibilitas dari mana saja.</div>
                        ...
                        <div class="xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12">
                            {{-- <div class="text-end landing-main-image landing-heading-img flex justify-end w-full"> --}}
                                <img src="{{ asset('eofficeadmin/images/media/landing/developer-team.png') }}" alt="" class="img-fluid">
                            {{-- </div> --}}
                        </div>
                    </div>
                </div>
        ...
        <section class="section !bg-[#f9fafb] dark:!bg-black/10 section-bg text-defaulttextcolor dark:text-defaulttextcolor/70" id="statistics">
            <div class="container text-center relative">
                <p class="text-[0.75rem] font-semibold text-success mb-1"><span class="landing-section-heading">STATISTIK</span></p>
                <h3 class="font-semibold mb-2 text-defaulttextcolor dark:text-defaulttextcolor/70 ">Statistik Penggunaan</h3>
                <div class="">
                    <div class="xl:col-span-7 col-span-12">
                        <p class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-12 font-normal">Lihat bagaimana E-Office telah membantu banyak pengguna dalam mengelola arsip mereka dengan lebih efektif</p>
                    </div>
                </div>
        ...
        <!-- End:: Section-2 -->
            ...
            <div class="container text-center">
                <p class="text-[0.75rem] font-semibold text-success mb-1"><span class="landing-section-heading">TENTANG</span></p>
                <h3 class="font-semibold mb-2 dark:text-defaulttextcolor dark:text-defaulttextcolor/70710">Tentang E-Office</h3>
                <div class="grid grid-cols-12 justify-center max-w-xl mx-auto">
                    <div class="col-span-12">
                        <p class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-4 font-normal">E-Office adalah aplikasi inovatif yang dirancang untuk memudahkan pengelolaan arsip surat masuk, surat keluar, dan disposisi di lingkungan kantor. Dengan fitur yang lengkap dan mudah digunakan, E-Office membantu meningkatkan efisiensi dan produktivitas pengelolaan arsip Anda.</p>
                    </div>
                </div>
                <div class="grid grid-cols-8 justify-center align-center">
                    <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 col-span-12 customize-image text-center">
                        <div class="lg:text-start !flex items-center lg:justify-start justify-center">
                            <img src="{{ asset('eofficeadmin/images/media/landing/new-messages.png')  }}" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12 pt-5 pb-0 lg:px-2 !text-start px-12 my-auto">
                        ...
                        <p class=" text-[#8c9097] dark:text-white/50 mb-4">E-Office BPKAD menawarkan sistem manajemen arsip yang menyatukan semua kebutuhan dokumen Anda dalam satu platform.</p>
                        <ul class="">
                            <li class="mb-4">
                                <div class="flex">
                                    <span>
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <p class=" text-[#8c9097] dark:text-white/50">Catat dan arsipkan setiap surat masuk dengan sistematis, sehingga memudahkan pencarian dan pengelolaan dokumen penting.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="mb-4">
                                <div class="flex">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <p class=" text-[#8c9097] dark:text-white/50">Buat, lacak, dan arsipkan surat keluar dengan mudah, memastikan setiap komunikasi tercatat dengan baik.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <p class=" text-[#8c9097] dark:text-white/50">Distribusikan tugas dan disposisi surat dengan efisien ke setiap bagian yang terkait, memastikan alur kerja yang lancar.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
        ...
        <!-- End:: Section-3 -->
        <!-- Start:: Section-4 -->
        <section class="section bg-[#f9fafb] section-bg text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]" id="fitur">
        <div class="container text-center">
            <p class="text-[0.75rem] font-semibold text-success mb-1"><span class="landing-section-heading">FITUR</span></p>
            <h3 class="font-semibold mb-2">Fitur E-Office</h3>
            <div>
                <div class="xl:col-span-7">
                    <p class="text-[#8c9097] dark:text-white/50 text-sm mb-12 font-normal">E-Office BPKAD: Pengelolaan dokumen cepat, efisien, dan aman.</p>
                </div>
            </div>
            <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="box-body">
                            <div class="items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-[#8c9097] dark:text-white/50">Mudah dan cepat dalam mengelola surat masuk. Dengan fitur unggah surat masuk, Anda dapat langsung mengunggah, menyimpan, dan mengkategorikan surat yang diterima. Sistem ini mendukung berbagai format file dan memungkinkan penambahan catatan atau tag untuk memudahkan pencarian dan referensi di masa depan.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-[#8c9097] dark:text-white/50">Pastikan surat keluar Anda terdokumentasi dengan baik. Fitur ini memungkinkan Anda membuat, mengunggah, dan menyimpan surat keluar dengan mudah. Anda dapat menambahkan informasi penerima, melacak status pengiriman, dan mengatur pengingat untuk tindak lanjut.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-[#8c9097] dark:text-white/50">Permudah alur kerja dengan fitur disposisi elektronik. Anda dapat mendistribusikan tugas dan instruksi terkait surat masuk dan surat keluar langsung melalui aplikasi. Dengan notifikasi real-time dan pelacakan status, semua pihak terkait akan selalu terinformasi dan dapat bertindak cepat.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-[#8c9097] dark:text-white/50">Dapatkan wawasan mendalam dengan fitur laporan terintegrasi. Anda dapat membuat laporan kustom mengenai surat masuk, surat keluar, dan disposisi. Laporan ini dapat diunduh dalam berbagai format dan dibagikan kepada pihak terkait untuk analisis dan pengambilan keputusan yang lebih baik.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-[#8c9097] dark:text-white/50">Pantau semua aktivitas surat masuk, surat keluar, disposisi, dan laporan melalui dashboard yang intuitif dan user-friendly. Dashboard ini memberikan gambaran lengkap tentang status pengelolaan dokumen dan memungkinkan Anda mengambil tindakan cepat jika diperlukan.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-[#8c9097] dark:text-white/50">Jangan lewatkan satupun dokumen penting dengan notifikasi dan pengingat otomatis. Sistem ini akan mengingatkan Anda tentang surat masuk yang perlu ditindaklanjuti, surat keluar yang memerlukan konfirmasi, dan disposisi yang belum selesai.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- End:: Section-4 -->
        ...
        <section class="section text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]" id="contact">
            <div class="container text-center">
                <p class="text-[0.75rem] font-semibold text-success mb-1"><span class="landing-section-heading">KONTAK</span></p>
                <h3 class="font-semibold mb-2">Hubungi Kami</h3>
                <div class="grid grid-cols-12 justify-center">
                    <div class="col-span-12">
                        <p class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-12 font-normal">Untuk pertanyaan, dukungan, atau informasi lebih lanjut mengenai E-Office BPKAD,<br> jangan ragu untuk menghubungi kami. Tim kami siap membantu Anda.</p>
                    </div>
                </div>
                    ...
                    <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-12 sm:col-spam-12 col-span-12">
                        <div class="box border dark:border-defaultborder/10 shadow-none">
                            <div class="box-body !p-0">
                                <iframe title="map" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1985.9179430680947!2d105.258443!3d-5.441875!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e40dbac2a3a2745%3A0x4184eb10d4c69557!2sBADAN%20PENGELOLAAN%20KEUANGAN%20DAN%20ASET%20DAERAH%20(BPKAD)%20PROVINSI%20LAMPUNG!5e0!3m2!1sid!2sid!4v1722265937699!5m2!1sid!2sid" height="365" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="grid grid-cols-12 gap-6">
                    <div class="xl:col-span-4 col-span-12">
                        <div class="px-6">
                            <p class="font-semibold mb-4"><a aria-label="anchor" href="index.html"><img src="{{ asset('eofficeadmin/images/brand-logos/eoffice-logo.png') }}" alt=""></a></p>
                            <p class="mb-2 opacity-[0.6] font-normal">
                                Solusi digital modern untuk pengelolaan dokumen dan arsip yang efisien. E-Office BPKAD mempermudah pengelolaan surat masuk, surat keluar, disposisi, dan laporan dengan teknologi canggih, keamanan tinggi, dan akses yang mudah.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="xl:col-span-4 col-span-12">
                        <div class="px-6">
                            ...
                            <ul class="list-unstyled font-normal landing-footer-list">
                                <li>
                                    <a href="javascript:void(0);" class="text-white opacity-[0.6]"><i class="ri-home-4-line me-1 align-middle"></i> Jl. Wolter Monginsidi No. 69. Teluk Betung Bandar Lampung kode pos 35215</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="text-white opacity-[0.6]"><i class="ri-mail-line me-1 align-middle"></i> bpkadlampung@gmail.com</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="text-white opacity-[0.6]"><i class="ri-phone-line me-1 align-middle"></i> (0721) 481 166</a>
                                </li>
                                <li class="mt-4 !mb-0">
        ...
        <div class="text-center landing-main-footer py-4 opacity-[0.87]">
            <span class="text-[#8c9097] dark:text-white/50 text-[0.9375rem]"> Copyright © <span id="year">2024</span> All
            rights
